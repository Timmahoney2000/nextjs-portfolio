...
import { IconBrandGithub, IconBrandLinkedin, IconBrandX, IconPhone } from '@tabler/icons-react';
    ...
    <section id='contact'>
      <div className="relative flex-col flex h-[20rem] w-full items-center justify-center bg-white dark:bg-black">
        ...
        <div className='my-6 z-20 mt-20'>
          <a href="https://outlook.live.com/mail/0/deeplink/compose?to=timmahoney2000@gmail.com" target="_blank" rel="noopener noreferrer" className="px-8 py-2 rounded-lg bg-gradient-to-r from-indigo-500 to-purple-500 text-white">
            Let&apos;s get in touch
          </a>
          <a href="/resume.docx" download className="px-8 py-2 rounded-lg bg-gradient-to-r from-indigo-500 to-purple-500 text-white">
    Download Resume
  </a>
        </div>
      </div>
      <div className='flex flex-col md:flex-row justify-between items-center py-6'>
        ...
        <div className='flex space-x-4'>
           <a href="tel:+19083978825" className='rounded-full bg-gray-100 dark:bg-neutral-800 w-10 h-10 flex items-center justify-center'>
            <IconPhone className='h-6 w-6 text-black dark:text-neutral-400'/>
          </a>
